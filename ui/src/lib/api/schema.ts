...
export interface paths {
    ...
    "/apps/creation": {
         ...
         */
        get: operations["get_creation_apps_creation_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/apps/setup_git": {
         ...
         */
        post: operations["test_connection_apps_setup_git_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/apps/name_available": {
         ...
         */
        post: operations["name_available_apps_name_available_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/apps/setup/claim_port": {
         ...
         */
        post: operations["setup_claim_port_apps_setup_claim_port_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/apps/delete_port": {
         ...
         */
        delete: operations["delete_port_apps_delete_port_delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/apps/setup_service": {
         ...
         */
        get: operations["setup_service_apps_setup_service_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    get_creation_apps_creation_get: {
        parameters: {
            query: {
                token: unknown;
            };
    ...
    test_connection_apps_setup_git_post: {
        parameters: {
            query: {
                token: string;
                name: unknown;
    ...
    name_available_apps_name_available_post: {
        parameters: {
            query: {
                name: string;
                token: string;
    ...
    setup_claim_port_apps_setup_claim_port_post: {
        parameters: {
            query: {
                token: string;
                host_port: number;
    ...
    delete_port_apps_delete_port_delete: {
        parameters: {
            query: {
                token: string;
                host_port: number;
    ...
    setup_service_apps_setup_service_get: {
        parameters: {
            query: {
                token: string;
