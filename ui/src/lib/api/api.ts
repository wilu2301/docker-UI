...
export const getApp = fetcher
  .path("/api/apps/{app_name}")
  .method("get")
  .create();

export const getAppVolumes = fetcher
  .path("/api/apps/{app_name}/volumes")
  .method("get")
  .create();

export const getServices = fetcher
  .path("/api/apps/{app_name}/services")
  .method("get")
  .create();
